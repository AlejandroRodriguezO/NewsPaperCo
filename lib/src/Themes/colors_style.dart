...
abstract class Styles {
  ...
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    ...
    return ThemeData(
      ...
      primaryColor: isDarkTheme ? Colors.black : Colors.red[900],
      bottomNavigationBarTheme: BottomNavigationBarTheme.of(context).copyWith(backgroundColor: isDarkTheme ? Colors.black45 : Colors.redAccent,),
      indicatorColor: isDarkTheme ? Color(0xff0E1D36) : Color(0xffCBDCF8),
      buttonColor: isDarkTheme ? Color(0xff3B3B3B) : Color(0xffF1F5FB),

      hintColor: isDarkTheme ? Color(0xff280C0B) : Color(0xffEECED3),

      highlightColor: isDarkTheme ? Color(0xff372901) : Color(0xFF0d47a1),
      ...
      accentColor: isDarkTheme ? Colors.red[900] : Colors.red[900],
